...
{   
    //default value 一些模擬用的設定
    uint32_t Duration = 5;           // Experiment duration
...
void
linksim::generateRoute(route_t *&fwd, route_t *&rev, uint32_t &src, uint32_t &dst, uint64_t flowSize, simtime_picosec startTime)
{   
